...
export const tails = [
  ...
  { type: 2, tail: ["עשוי לקרות להערכתו של מישהו?", "קרה להערכתו של מישהו?"] },
  { type: 3, tail: ["בכוונתו של מישהו לעשות?", "מטרתו של מישהו?"] },
  { type: 4, tail: ["ברצונו של מישהו?", "מתחשק למישהו?"] },
  {
    type: 5,
    tail: [
      "הנסיבות מאפשרות?",
