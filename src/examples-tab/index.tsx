        ...
        exampleSentences.map((sentenceSet, i) => (
            <Container
                ...
                <Card
                    ...
                    key={i}
                    dir="rtl"
                    className="bd tw-flex tw-flex-col tw-p-4 tw-w-full tw-h-full">
                        ...
                        {sentenceSet.head.map((head: string, ind: number) => (
                            <div key={ind} className="tw-flex tw-flex-col">
                                ...
                                <div className="tw-flex tw-flex-col tw-px-0">
                                                    ...
                                                    <div className="tw-flex tw-flex-col tw-w-full">
                                                        ...
                                                        <div className="tw-flex tw-flex-row tw-w-full tw-mb-0 tw-h-[24px]">
                                                            ...
                                                            <Form.Control
                                                                ...
                                                                rows={1}
                                                                value={
                                                                    sentenceSet.completion === undefined
                                                                        ? ""
                                                                        : sentenceSet.completion[ind]
                                                                }
                                                            />
                                                        </div>
                                    ...
                                    <span
                                        hidden={sentenceSet.postPartOne[ind]?.length === 0}
                                        className="tw-text-[#006D77] tw-pb-2">
                                        {sentenceSet.postPartOne[ind]}
                                    </span>
                                    <span
                                        hidden={sentenceSet.betweenParts[ind]?.length === 0}
                                        className="tw-text-[#006D77]">
                                    ...
                                    {!sentenceSet.followUp[ind] || sentenceSet.followUp[ind]?.length === 0 ? (
                                        ...
                                        <div className="tw-pt-8 tw-flex tw-flex-col tw-mx-0 tw-h-full tw-w-full">
                                            ...
                                            {!sentenceSet.preFollowUpQuestion[ind] ? (
                                                ...
                                                <div key={ind} className="tw-pb-2">
                                                    ...
                                                    <div className="tw-pt-2">
                                                        ...
                                                        <span className="h6 tw-pb-2 tw-font-bold">
                                                            {sentenceSet.followUp[ind]}
                                                        </span>
                                                    </div>
                                                </div>
                                            )}
                                            ...
                                            <FormGroup className="tw-p-0 tw-border-0 hover:tw-bg-transparent focus:tw-shadow-none focus:tw-outline-none focus-within:tw-outline-none">
                                                ...
                                                <span className="tw-text-[#006D77] tw-pb-2">
                                                    {sentenceSet.postFollowUpPair[ind]}
                                                </span>
                                            </FormGroup>
                                ...
                                <div className={"tw-flex tw-flex-col tw-w-full tw-justify-between tw-align-bottom"}>
                                    ...
                                    <span className="tw-whitespace-pre-line tw-mt-8 tw-text-[#006D77] tw-pb-2">
                                        {sentenceSet.additionalSave[ind]}
                                    </span>
                                    ...
                                    {i !== numOfExamples - 1 || ind === sentenceSet.head.length - 1 ? (
                                        <>
                                            <span className="tw-text-[#006D77] tw-py-2">
                                                {sentenceSet.additionalNext[ind]}
                                            </span>
                    ...
                    {chosen !== numOfExamples - 1 || !showExamplesModal ? (
                        <div>
                            <span className="tw-whitespace-pre-line tw-pt-2 tw-text-[#006D77]">
                                {
                                    "שימו לב: במהלך הניסוי יוצגו מדי פעם גם שאלות פשוטות לבדיקת עירנות. ענו עליהן בדיוק לפי מה שיהיה מוסבר בהוראות.\nבהצלחה!"
                                }
                            </span>
                        </div>
                    ) : (
                        <div>
                            <span>
                                שימו לב: במהלך הניסוי יוצגו מדי פעם גם שאלות פשוטות לבדיקת עירנות. ענו עליהן בדיוק לפי
                                מה שיהיה מוסבר בהוראות.
                            </span>
        ...
        <CollapsableCard bgColor="#e3ebde" header="דוגמאות">
            <div className="tw-text-right tw-select-none">
                ...
                {chosen == -1 ? (
                    ...
                    <Container className="tw-px-0 tw-mt-8 tw-select-text">{generateExamples()}</Container>
                )}
            </div>
        </CollapsableCard>
    );
